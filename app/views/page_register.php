                    ...
                    <div class="d-flex align-items-center container p-0">
                        <div class="page-logo width-mobile-auto m-0 align-items-center justify-content-center p-0 bg-transparent bg-img-none shadow-0 height-9 border-0">
                            <a href="/" class="page-logo-link press-scale-down d-flex align-items-center">
                                ...
                                <span class="page-logo-text mr-1">Список пользователей</span>
                            </a>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 ml-auto mr-auto">
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    <!-- </div> -->
                                    <form id="js-login" novalidate="" action="/regform" method="POST">
                                        <div class="form-group">
                                            <label class="form-label" for="username">Имя <br></label>
                                            <input type="text" id="username" class="form-control" name="name" placeholder="" required>
