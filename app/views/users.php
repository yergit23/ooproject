    ...
    <body class="mod-bg-1 mod-nav-link">
                            ...
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <div class="info-card-text flex-1">
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        <?=$user['username']; ?>
                                        <?php if($urole == 'ADMIN' || $user['id'] == $uid): ?>
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="/status?id=<?=$user['id'] ?>">
                                            <i class="fa fa-sun"></i>
                                        Установить статус</a>
                                        <a class="dropdown-item" href="/umedia?id=<?=$user['id'] ?>">
                                            <i class="fa fa-camera"></i>
                                            Загрузить аватар
                                        </a>
                                        <a href="/delete?id=<?=$user['id'] ?>" class="dropdown-item" onclick="return confirm('Вы уверены?');">
        ...
        <footer class="page-footer" role="contentinfo">
            <div class="d-flex align-items-center flex-1 text-muted">
                <span class="hidden-md-down fw-700">2023 © Список пользователей</span>
            </div>
            <div>
